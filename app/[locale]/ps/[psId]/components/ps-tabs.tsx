...
export function PsTabs({ psId }: { psId: string }) {
  return (
    <Tabs defaultValue="ringkasan" className="w-full">
      <TabsList className="inline-flex h-auto items-center justify-start gap-1 mb-6 rounded-md bg-gradient-to-r from-green-700 to-green-900 p-1 text-white overflow-x-auto whitespace-nowrap">
        <TabsTrigger 
          value="ringkasan" 
