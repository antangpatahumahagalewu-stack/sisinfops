    ...
    <aside className={cn(
      ...
      <div className="flex h-16 items-center border-b px-4">
        <div className="flex items-center gap-2">
          ...
          {!collapsed && (
            <div>
              <h1 className="font-bold text-sm">SIPS+</h1>
              <p className="text-xs text-muted-foreground">Carbon Project OS</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="border-t p-4">
        ...
        >
          ...
          {!collapsed && <span className="ml-2 text-xs">Sembunyikan</span>}
        </Button>
      </div>
    </aside>
  )
