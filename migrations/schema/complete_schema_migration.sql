-- ====================================================================
-- COMPLETE DATABASE MIGRATION FOR SIPS+ APPLICATION
...
-- 23. storage_buckets (managed by Supabase Storage, just for reference)
-- Note: Supabase Storage handles buckets automatically
...
-- Carbon module indexes
CREATE INDEX IF NOT EXISTS idx_carbon_projects_ps_id ON carbon_projects(ps_id);
...
-- Program module indexes
CREATE INDEX IF NOT EXISTS idx_program_activities_program_id ON program_activities(program_id);
CREATE INDEX IF NOT EXISTS idx_monev_results_indicator_id ON monev_results(indicator_id);
CREATE INDEX IF NOT EXISTS idx_monev_results_period ON monev_results(reporting_period);
...
-- ====================================================================
-- PART 9: SETUP RLS POLICIES (FIXED - No Recursion)
-- ====================================================================
...
ALTER TABLE monev_indicators ENABLE ROW LEVEL SECURITY;
ALTER TABLE monev_results ENABLE ROW LEVEL SECURITY;
...
-- Finance module policies (role-based)
...
-- ====================================================================
-- PART 10: CREATE TRIGGERS FOR UPDATED_AT AND AUDIT
-- ====================================================================
...
BEGIN
    ...
    RAISE NOTICE 'Data initialized:';
    RAISE NOTICE '  - kabupaten: 5 rows';
...
-- FINAL MESSAGE
-- ====================================================================
SELECT '✅ Complete Phase 2 Database Migration Successful!' AS status;
